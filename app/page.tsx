    ...
    <main>
      ...
      <div className="animate-[fade-me-in_.5s_ease-in-out]">
        <div className="flex justify-center w-full p-5 pt-0 px-10 relative">
          <div className="flex relative flex-row w-full max-w-[1040px] rounded-xl overflow-hidden mt-[130px] shadow-xl">
        ...
        <div className="flex flex-col justify-center items-center w-full p-5 px-10 mt-0 my-5">
          ...
          <div className="flex flex-row w-full max-w-[1040px]">
            <div className="w-full overflow-hidden min-h-[350px] grid grid-cols-8">
        ...
        <div className="flex justify-center w-full p-5 px-10">
          <div className="flex flex-col w-full max-w-[1040px]">
            <div className="grid lg:grid-rows-1 lg:grid-cols-3 gap-8">
              ...
              <div className="w-full rounded-2xl min-h-[200px] border border-[#0089c8] text-[#025176] overflow-hidden">
                <div className="p-5 pb-10">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Alias esse officia deserunt laboriosam repudiandae veritatis eaque vel sunt perspiciatis nisi, quos accusantium ratione suscipit minima non? Est aliquam quo quasi doloremque. Quod suscipit accusantium culpa quam. Alias atque adipisci laborum minima, sint deleniti aliquid, perferendis accusantium iusto quos sequi dolorem?
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="flex justify-center w-full p-5 px-10 mt-0 py-10">
          <div className="flex flex-col w-full max-w-[1040px]">
