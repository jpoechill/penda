      ...
      <div className="animate-[fade-me-in_.5s_ease-in-out]">
        <div className="flex flex-col mt-0 justify-center items-center w-full pt-0 p-5 px-10 my-5">
          ...
          <div className="w-full mb-10 max-w-[1040px] overflow-hidden">
            <Image src="/img/about_06.jpg" alt="Group Photo" className="rounded-2xl h-[300px] lg:h-full w-full index-0 object-cover bg-cover bg-no-repeat" priority width={1200} height={500}></Image>
          </div>
